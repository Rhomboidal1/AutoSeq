...
class MseqConfig:
    ...
    def get_project_root():
        ...
        # Assuming config.py is in AutoSeq/utils/
        return os.path.dirname(os.path.dirname(script_dir))

    PROJECT_ROOT = get_project_root()

    # Add the project's root to sys.path (optional, but can be helpful)
    # sys.path.append(PROJECT_ROOT)  # Be cautious with this
